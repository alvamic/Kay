              ...
              <GridItem xs={12} sm={12} md={4}>
                <Card className={classes[this.state.cardAnimaton]}>
                  <form className={classes.form}>
                    ...
                    />
                     <Button onClick={this.bandaidClickHandler}  round color="white" size="lg"><Link style={{ color: 'black',textDecoration: 'none' }} to={'/google'}>
                        Login
                        </Link>
                      </Button>
                      </div>
...
{/*  -------------------------------------------------------------------------------------*/}
                    ...
                    <CardFooter className={classes.cardFooter}>
                      <Button onClick={this.onSignUp} round color="success" size="lg"><Link style={{ textDecoration: 'none' }}to={'/google'}>
                      Sign Up
                        </Link>
